    ...
    <form id="bookingForm" class="book-form">
      <div class="flex">
        <div class="inputBox">
          ...
          <span class="error" id="nameError" style="color:red; font-size: 14px; font-weight: bold;"></span>
        </div>
        <div class="inputBox">
          <span>Email:</span>
          <input type="email" id="email" placeholder="Enter your email" required>
          <span class="error" id="emailError" style="color:red; font-size: 14px; font-weight: bold;"></span>
        </div>
        <div class="inputBox">
          <span>Phone:</span>
          <input type="text" id="phone" placeholder="Enter your phone number" required>
          <span class="error" id="phoneError" style="color:red; font-size: 14px; font-weight: bold;"></span>
        </div>
        <div class="inputBox">
          <span>Package:</span>
